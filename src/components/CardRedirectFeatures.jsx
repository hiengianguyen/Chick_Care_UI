import { Droplets, MousePointer2, Sun, UtensilsCrossed, Wind, Activity, LayoutGrid } from "lucide-react";
...
function CardRedirectFeatures() {
  ...
  const devices = [
    ...
    { id: "other", name: "Khác", icon: LayoutGrid, color: "bg-gray-500" }
  ];
  return (
    <div className="space-y-6">
      ...
      <button
        ...
        className="w-full group relative bg-white p-10 rounded-[2.5rem] border-2 border-transparent hover:border-indigo-500 shadow-xl hover:shadow-2xl transition-all duration-500 text-left flex flex-col md:flex-row items-center gap-10 overflow-hidden"
      >
